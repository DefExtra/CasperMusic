...
class StopCommand extends BaseCommand_1.default {
    ...
    run(client, interaction, message, args, author) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (lang == "ar")
                quick_db_1.default.set(`Lang_${base.guildId}`, "en");
            else if (lang == "en")
                quick_db_1.default.set(`Lang_${base.guildId}`, "ar");
            if (message == null)
                interaction
                    .editReply({
                    content: replys.doneChangeTheLang.replace("{status}", lang),
                })
                    .catch(() => { });
            else
                message
