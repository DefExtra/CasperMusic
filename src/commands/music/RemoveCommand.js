    ...
    constructor() {
        super(commandName, "music", [], {
            ...
            options: [
                {
                    name: "position",
                    description: "the track position.",
                    type: "NUMBER",
                    required: true,
                },
            ],
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_c = (_a = client.manager) === null || _a === void 0 ? void 0 : _a.players.get(((_b = base.guild) === null || _b === void 0 ? void 0 : _b.id) || "")) === null || _c === void 0 ? void 0 : _c.queue.current) &&
                ...
                if (interaction == null) {
                    ...
                    option = interaction.options.getNumber("position");
                }
                if (!option || option == null) {
                    if (message == null)
                        interaction
                            .editReply({
                            content: replys.removeCMDuseg,
                        })
                            .catch(() => { });
                    else
                        message
                ...
                if (!((_f = check[option]) === null || _f === void 0 ? void 0 : _f.title) ||
                    !((_g = check[option]) === null || _g === void 0 ? void 0 : _g.title) == null ||
                    !((_h = check[option]) === null || _h === void 0 ? void 0 : _h.title) == undefined) {
                    if (message == null)
                        interaction
                            .editReply({
                            content: replys.invaild,
                        })
                            .catch(() => { });
                    else
                        message
                ...
                for (let index = 0; index < (player ? player === null || player === void 0 ? void 0 : player.queue.length : ""); index++) {
                    if (index !== option)
                        newQueueArray.push(player === null || player === void 0 ? void 0 : player.queue[index]);
                }
                setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (message == null)
                        interaction
                            .editReply({
                            content: replys.doneRemove.replace("{number}", option),
                        })
                            .catch(() => { });
                    else
                        message
                ...
                if (!((_l = (_j = client.manager) === null || _j === void 0 ? void 0 : _j.players.get(((_k = base.guild) === null || _k === void 0 ? void 0 : _k.id) || "")) === null || _l === void 0 ? void 0 : _l.queue.current)) {
                    if (message == null)
                        interaction
                            .editReply({
