...
const commandName = "lyrics";
class StopCommand extends BaseCommand_1.default {
    constructor() {
        super(commandName, "music", ["ly"], {
            name: commandName,
            description: "lyrics for a spacific track.",
            type: "CHAT_INPUT",
            options: [
                {
                    name: "position",
    ...
    run(client, interaction, message, args, author) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_c = (_a = client.manager) === null || _a === void 0 ? void 0 : _a.players.get(((_b = base.guild) === null || _b === void 0 ? void 0 : _b.id) || "")) === null || _c === void 0 ? void 0 : _c.queue.current) &&
                ...
                let songURI = (player === null || player === void 0 ? void 0 : player.queue[interaction !== null ? interaction.options.getNumber("position") : 0 || 0]) ||
                ...
                if (message == null)
                    ...
                    message
                        ...
                        .catch(() => { });
                try {
                    lyricsFinder.LyricsFinder(songURI?.title).then((respond) => {
                        if (message == null)
                            interaction
                                .editReply({
                                content: "your lyrics:",
