    ...
    run(client, interaction, message, args, author) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_c = (_a = client.manager) === null || _a === void 0 ? void 0 : _a.players.get(((_b = base.guild) === null || _b === void 0 ? void 0 : _b.id) || "")) === null || _c === void 0 ? void 0 : _c.queue.current) &&
                ...
                player === null || player === void 0 ? void 0 : player.set(`autoplay`, !(player === null || player === void 0 ? void 0 : player.get(`autoplay`)));
                if (message == null)
                    interaction
                        .editReply({
                        content: replys.autoPlay.replace("{autoplay[status]}", (player === null || player === void 0 ? void 0 : player.get(`autoplay`)) ? `🟢 Enabled` : `🔴 Disabled`),
                    })
                        .catch(() => { });
                else
                    message
