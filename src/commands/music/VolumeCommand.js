...
class StopCommand extends BaseCommand_1.default {
    constructor() {
        super(commandName, "music", ["vol"], {
            name: commandName,
            description: "edit the track volume",
            type: "CHAT_INPUT",
            options: [
                {
                    name: "vol",
                    description: "the new volume deg.",
                    type: "NUMBER",
                    required: true,
                },
            ],
    ...
    run(client, interaction, message, args, author) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_c = (_a = client.manager) === null || _a === void 0 ? void 0 : _a.players.get(((_b = base.guild) === null || _b === void 0 ? void 0 : _b.id) || "")) === null || _c === void 0 ? void 0 : _c.queue.current) &&
                ...
                let option;
                if (message == null)
                    option = interaction.options.getNumber("vol", true);
                else if (interaction == null)
                    option = args[0] ? Number(args.join(" ")) : null;
                if (!option || option == null) {
                    if (message == null)
                        interaction
                            .editReply({
                            content: replys.notVolArg,
                        })
                            .catch(() => { });
                    else
                        message
                ...
                player === null || player === void 0 ? void 0 : player.setVolume(option);
                if (message == null)
                    interaction.editReply({
                        content: replys.volumeUpdate.replace("{volume[volume]}", String(player === null || player === void 0 ? void 0 : player.volume) || ""),
                    });
                else
                    message
                        .edit({
